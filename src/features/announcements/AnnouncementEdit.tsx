...
const schema = yup.object({
	...
	externalName: yup.string().when("externalUrl", ([externalUrl], schema) => {
		return externalUrl
			? schema.required("a display name is required for the url")
			: schema.notRequired()
	}),
})
			...
			>
				{({ handleSubmit, setFieldValue, handleChange, handleBlur, values, touched, errors }) => (
					<Form noValidate onSubmit={handleSubmit}>
						<Form.Group controlId="announcement.Title" className="mb-2">
						...
						<Form.Group controlId="announcement.Starts" className="mb-2">
						...
						<Form.Group controlId="announcement.Expires" className="mb-2">
						...
						<Form.Group controlId="document" className="mb-2">
							<Form.Label className="mb-0">Attach a Document (optional)</Form.Label>
							<Form.Control
								as="select"
								name="document"
						...
						<Form.Group controlId="announcement.ExternalUrl" className="mb-2">
							<Form.Label className="mb-0">Link (optional)</Form.Label>
							<Form.Control
								type="url"
								placeholder="Url"
								name="externalUrl"
						...
						<Form.Group controlId="announcement.ExternalName" className="mb-2">
							<Form.Label className="mb-0">Link name (optional)</Form.Label>
							<Form.Control
