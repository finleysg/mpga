...
const PasswordReset: React.FC = () => {
  ...
  const resetPassword = (credentials: IPasswordReset) => {
    const confirm = new PasswordResetRequest(uid || "", token || "", credentials.password, credentials.confirmPassword);
      ...
      <Card>
        ...
        <Card.Body>
          ...
          {session.flags.passwordResetConfirmed && (
            <p className="text-success">Your password has been changed. Log in now with your new password.</p>
          )}
