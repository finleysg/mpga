...
import { resetPassword } from "../../store/UserStore"
				...
				<Card.Body>
					...
					{session.flags.pendingPasswordReset && (
						<p className="text-success mt-3">
							An email has been sent to the address you entered above. If you don't receive a reset
							link within a few minutes, check to ensure that your email client is not flagging
							email from mpga.net as junk or spam. If we don't have an account record with this
							email, that would be another reason you might not receive a reset link. In that case,
