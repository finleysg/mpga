...
import { saveLocation } from "../../store/AppStore"
	...
	return (
		<React.Fragment>
			<EditContainer
				...
				viewComponent={
					<React.Fragment>
						...
						{!permissions.canPostMatchResult() && (
							<div>
								<p>
									To post a match play result, please log in. If you don't have an account, click
				...
				editComponent={
					<MatchResultEdit result={new MatchResult({ id: 0 })} onClose={() => setDoEdit(false)} />
				}
			/>
		</React.Fragment>
	)
