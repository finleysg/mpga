...
export default class Constants {
  ...
  public static MatchPlayYear: number = Number(
    getStringFromConfig("REACT_APP_MATCH_PLAY_YEAR")
  );
  public static MemberClubYear: number = Number(
    getStringFromConfig("REACT_APP_MEMBER_CLUB_YEAR")
  );
  public static MembershipDues: number = Number(
    getStringFromConfig("REACT_APP_MEMBERSHIP_DUES")
  );
  public static StripePublicKey: string = getStringFromConfig(
